...
using WebClient.Models.AccountViewModels;
...
namespace WebClient.Controllers
{
    public class AccountController : Controller
    {
        ...
        // TODO : study more details about what happens here when signing out
                ...
                public async Task<IActionResult> Login(LoginViewModel model, string returnUrl = null ,string Auth =null )
                {
        ...
        public async Task<IActionResult> SignedOut()
        {
            ...
            if (HttpContext.AuthenticateAsync().IsCompleted)
                await HttpContext.SignOutAsync("Cookies");
            else await  HttpContext.SignOutAsync("oidc");
