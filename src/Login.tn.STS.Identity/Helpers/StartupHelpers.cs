...
using SendGrid;
using Login.tn.STS.Identity.Configuration;
using Login.tn.STS.Identity.Configuration.ApplicationParts;
using Login.tn.STS.Identity.Configuration.Constants;
using Login.tn.STS.Identity.Configuration.Interfaces;
using Login.tn.STS.Identity.Helpers.Localization;
using Login.tn.STS.Identity.Services;
using System.Linq;
using Skoruba.IdentityServer4.Admin.EntityFramework.Interfaces;
using Login.tn.Admin.EntityFramework.MySql.Extensions;
using Login.tn.Admin.EntityFramework.PostgreSQL.Extensions;
using Login.tn.Admin.EntityFramework.Shared.Configuration;
using Login.tn.Admin.EntityFramework.SqlServer.Extensions;
using Skoruba.IdentityServer4.Admin.EntityFramework.Helpers;

namespace Login.tn.STS.Identity.Helpers
{
    public static class StartupHelpers
    {
            ...
            IConfiguration configuration)
        {
            ...
            authenticationBuilder.AddGoogle("google",options =>
            {
                ...
                options.ClientId = "190283944135-ds11fpe7nqjnoutdo0tdqg4hb18s4lnb.apps.googleusercontent.com";
                options.ClientSecret = "kLdsXerLVUeth0k3itMmhPE3";
