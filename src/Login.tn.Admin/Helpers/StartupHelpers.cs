...
using Login.tn.Admin.ExceptionHandling;
using Login.tn.Admin.Configuration;
using Login.tn.Admin.Configuration.ApplicationParts;
...
using Login.tn.Admin.Helpers.Localization;
using System.Linq;
...
namespace Login.tn.Admin.Helpers
{
